...
class UpdateTransaksiForm(forms.Form):
    ...
    tanggal_pembayaran = forms.DateField(disabled= True,label='Tanggal Pembayaran', required=False, input_formats=DATE_INPUT_FORMATS)
    waktu_pembayaran = forms.DateTimeField(disabled= True,label='Waktu Pembayaran',required=False, input_formats=DATETIME_INPUT_FORMATS)

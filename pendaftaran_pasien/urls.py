...
from .views import create_daftar_pasien_view, list_daftar_pasien_view, detail_daftar_pasien_view, delete_daftar_pasien_view, update_daftar_pasien_view

urlpatterns = [
    path('create/', create_daftar_pasien_view, name='create_pasien'),
    path('', list_daftar_pasien_view, name='list_pasien'),
